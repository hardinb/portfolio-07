...
Your score on openness to experience shows that you are in the `r unique(hexaco_norm$ag_qscore)`th percentile for openness to experience. This means that you scored higher than `r unique(hexaco_norm$ag_qscore)`% of people on the dimension of openness to experience.
