...
## arguments: 
  ...
  a_output <- ggplotly(agplot, tooltip = "text")
  ...
  ex_output <- ggplotly(explot, tooltip = "text")
  ...
  h_output <- ggplotly(hhplot, tooltip = "text")
  ...
  c_output <- ggplotly(cnplot, tooltip = "text")
  ...
  em_output <- ggplotly(emplot, tooltip = "text")
  ...
  o_output <- ggplotly(opplot, tooltip = "text")
  
  #gathering and presenting our plots
  out <- list(a_output, ex_output, h_output, c_output, em_output, o_output)
  print(out)
}
```
